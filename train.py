...
upsampled_logits = tf.nn.conv2d_transpose(logits, upsample_filter_tensor_x2,
                                          ...
                                          strides=[1, 2, 2, 1],
                                          padding='SAME')
## pool45 -- 2x+prediction
upsampled_logits = upsampled_logits + aux_logits_16s

upsample_filter_np_x2_45 = bilinear_upsample_weights(2,  # upsample_factor,
                                                  number_of_classes)

upsample_filter_tensor_x2_45 = tf.Variable(upsample_filter_np_x2_45, name='vgg_16/fc8/t_conv_x2_45')

upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_tensor_x2_45,
